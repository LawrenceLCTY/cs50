...
function Player:hitGoal()
    if self.map:tileAt(self.x - 1, self.y).id == FLAG_0 or 
        self.map:tileAt(self.x - 1, self.y + self.height - 1).id == FLAG_0 or
        self.map:tileAt(self.x + self.width, self.y).id == FLAG_0 or
        self.map:tileAt(self.x + self.width, self.y + self.height - 1).id == FLAG_0 then
            return true
    end
